...
>- _ChronoUnit_ iki _Tmporal_ zamanın birbirinden ne kadar uzakta olduğunu belirlemenin harika bir yoludur.
> ```java
...
- **plus()** and **minus()** _Duration_
  ...
  - _Duration_ _LocalTime_ ve _LocalTime_ içeren sınıflar ile çalışır.
