...
Bir dosyadan diğer dosyaya nasıl gidebileceğimizi belirler. Bu işlemin gerçekleşebilmesi için iki parametreninde aynı anda
_absolute_ veya _relative_ olması gerekiyor.
