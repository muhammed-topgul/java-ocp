...
- Bu işlemin gerçekleşebilmesi için iki parametreninde aynı anda _absolute_ veya _relative_ olması gerekiyor. 
- Farklı disklerde olursa (_C:\\_ ve _D:\\_) o zaman yine hata fırlatır.
